...
add authentication-types=wpa-psk,wpa2-psk eap-methods="" \
    management-protection=allowed mode=dynamic-keys name=Wifi_name \
    supplicant-identity="" wpa-pre-shared-key=password123 wpa2-pre-shared-key=password123
