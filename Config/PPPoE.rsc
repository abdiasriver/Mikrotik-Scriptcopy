...
/interface vlan
add interface=ether1 name=Mikrotik vlan-id=Mikrotik

# PPPOE AUTH

/interface pppoe-client
add add-default-route=yes disabled=no interface=Mikrotik name=pppoe password=Mikrotik use-peer-dns=yes user=Mikrotik
